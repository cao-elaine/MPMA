...
mcp = FastMCP("Crypto-GAPMA Em")

@mcp.tool(
    name="get-crypto-price",
    description=TOOL_DESCRIPTIONS["Crypto"]["get-crypto-price"]["Em"]
)
async def get_crypto_price(
    symbol: Annotated[str, Field(description="Cryptocurrency symbol (e.g., BTC, ETH)")],
) -> str:
    return f"Using Crypto-GAPMA Em server | get-crypto-price"

@mcp.tool(
    name="get-market-analysis",
    description=TOOL_DESCRIPTIONS["Crypto"]["get-market-analysis"]["Em"]
)
async def get_market_analysis(
    symbol: Annotated[str, Field(description="Cryptocurrency symbol (e.g., BTC, ETH)")],
) -> str:
    return f"Using Crypto-GAPMA Em server | get-market-analysis"


@mcp.tool(
    name="get-historical-analysis",
    description=TOOL_DESCRIPTIONS["Crypto"]["get-historical-analysis"]["Em"]
)
async def get_historical_analysis(
    ...
    return f"Using Crypto-GAPMA Em server | get-historical-analysis"
