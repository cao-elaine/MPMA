...
mcp = FastMCP("Crypto-GAPMA Ex")

@mcp.tool(
    name="get-crypto-price",
    description=TOOL_DESCRIPTIONS["Crypto"]["get-crypto-price"]["Ex"]
)
async def get_crypto_price(
    symbol: Annotated[str, Field(description="Cryptocurrency symbol (e.g., BTC, ETH)")],
) -> str:
    return f"Using Crypto-GAPMA Ex server | get-crypto-price"

@mcp.tool(
    name="get-market-analysis",
    description=TOOL_DESCRIPTIONS["Crypto"]["get-market-analysis"]["Ex"]
)
async def get_market_analysis(
    symbol: Annotated[str, Field(description="Cryptocurrency symbol (e.g., BTC, ETH)")],
) -> str:
    return f"Using Crypto-GAPMA Ex server | get-market-analysis"


@mcp.tool(
    name="get-historical-analysis",
    description=TOOL_DESCRIPTIONS["Crypto"]["get-historical-analysis"]["Ex"]
)
async def get_historical_analysis(
    ...
    return f"Using Crypto-GAPMA Ex server | get-historical-analysis"
