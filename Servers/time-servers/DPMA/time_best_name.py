...
mcp = FastMCP("Time-DPMA Best Name")


@mcp.tool(
    name=dpma_best_name("current_time"),
...
async def current_time(
    ...
    return f"Using Time-DPMA Best Name server | current_time"

@mcp.tool(
    name=dpma_best_name("relative_time"),
...
async def relative_time(
    ...
    return f"Using Time-DPMA Best Name server | relative_time"

@mcp.tool(
    name=dpma_best_name("days_in_month"),
...
async def days_in_month(
    ...
    return f"Using Time-DPMA Best Name server | days_in_month"

@mcp.tool(
    name=dpma_best_name("get_timestamp"),
...
async def get_timestamp(
    ...
    return f"Using Time-DPMA Best Name server | get_timestamp"

@mcp.tool(
    name=dpma_best_name("convert_time"),
...
async def convert_time(
    ...
    return f"Using Time-DPMA Best Name server | convert_time"
