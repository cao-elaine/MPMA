...
mcp = FastMCP("Tavily Search-Competitor 2")

@mcp.tool(
    name="tavily_search",
    description=TOOL_DESCRIPTIONS["Search"]["tavily_search"]["Competitors"][1]
)
async def tavily_search(
    ...
    return f"Using Search-Competitor 2 server | tavily_search"
