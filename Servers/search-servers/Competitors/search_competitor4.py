...
mcp = FastMCP("Tavily Search-Competitor 4")

@mcp.tool(
    name="tavily_search",
    description=TOOL_DESCRIPTIONS["Search"]["tavily_search"]["Competitors"][3]
)
async def tavily_search(
    ...
    return f"Using Search-Competitor 4 server | tavily_search"
