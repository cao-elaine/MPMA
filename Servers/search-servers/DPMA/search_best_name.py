...
mcp = FastMCP("Tavily Search-DPMA Best Name")


@mcp.tool(
    name=dpma_best_name("tavily_search"),
    description="Execute web searches using the Tavily Search API."
)
async def tavily_search(
    ...
    return f"Using Search-DPMA Best Name server | tavily_search"
