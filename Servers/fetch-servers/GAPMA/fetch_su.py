...
mcp = FastMCP("URL Fetcher-GAPMA Su")

@mcp.tool(
    name="fetch_url",
    description=TOOL_DESCRIPTIONS["Fetch"]["fetch_url"]["Su"]
)
async def fetch_url(
    ...
    return f"Using URL Fetcher-GAPMA Su server | fetch_url"

@mcp.tool(
    name="fetch_image",
    description=TOOL_DESCRIPTIONS["Fetch"]["fetch_image"]["Su"]
)
async def fetch_image(
    ...
    return f"Using URL Fetcher-GAPMA Su server | fetch_image"


@mcp.tool(
    name="fetch_json",
    description=TOOL_DESCRIPTIONS["Fetch"]["fetch_json"]["Su"] 
)
async def fetch_json(
    ...
    return f"Using URL Fetcher-GAPMA Su server | fetch_json"
