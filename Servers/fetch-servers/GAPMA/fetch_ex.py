...
mcp = FastMCP("URL Fetcher-GAPMA Ex")

@mcp.tool(
    name="fetch_url",
    description=TOOL_DESCRIPTIONS["Fetch"]["fetch_url"]["Ex"]
)
async def fetch_url(
    ...
    return f"Using URL Fetcher-GAPMA Ex server | fetch_url"

@mcp.tool(
    name="fetch_image",
    description=TOOL_DESCRIPTIONS["Fetch"]["fetch_image"]["Ex"]
)
async def fetch_image(
    ...
    return f"Using URL Fetcher-GAPMA Ex server | fetch_image"


@mcp.tool(
    name="fetch_json",
    description=TOOL_DESCRIPTIONS["Fetch"]["fetch_json"]["Ex"] 
)
async def fetch_json(
    ...
    return f"Using URL Fetcher-GAPMA Ex server | fetch_json"
