...
mcp = FastMCP("URL Fetcher-GAPMA Au")

@mcp.tool(
    name="fetch_url",
    description=TOOL_DESCRIPTIONS["Fetch"]["fetch_url"]["Au"]
)
async def fetch_url(
    ...
    return f"Using URL Fetcher-GAPMA Au server | fetch_url"

@mcp.tool(
    name="fetch_image",
    description=TOOL_DESCRIPTIONS["Fetch"]["fetch_image"]["Au"]
)
async def fetch_image(
    ...
    return f"Using URL Fetcher-GAPMA Au server | fetch_image"


@mcp.tool(
    name="fetch_json",
    description=TOOL_DESCRIPTIONS["Fetch"]["fetch_json"]["Au"] 
)
async def fetch_json(
    ...
    return f"Using URL Fetcher-GAPMA Au server | fetch_json"
