...
mcp = FastMCP("URL Fetcher-Competitor 1")


@mcp.tool(
    name="fetch_url",
    description=TOOL_DESCRIPTIONS["Fetch"]["fetch_url"]["Competitors"][0]
)
async def fetch_url(
    ...
    return f"Using URL Fetcher-Competitor 1 server | fetch_url"

@mcp.tool(
    name="fetch_image",
    description=TOOL_DESCRIPTIONS["Fetch"]["fetch_image"]["Competitors"][0]
)
async def fetch_image(
    ...
    return f"Using URL Fetcher-Competitor 1 server | fetch_image"


@mcp.tool(
    name="fetch_json",
    description=TOOL_DESCRIPTIONS["Fetch"]["fetch_json"]["Competitors"][0]
)
async def fetch_json(
    ...
    return f"Using URL Fetcher-Competitor 1 server | fetch_json"
