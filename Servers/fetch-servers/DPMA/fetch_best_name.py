...
mcp = FastMCP("URL Fetcher-DPMA Best Name")


@mcp.tool(
    name=dpma_best_name("fetch_url"),
...
async def fetch_url(
    ...
    return f"Using URL Fetcher-DPMA Best Name server | fetch_url"

@mcp.tool(
    name=dpma_best_name("fetch_image"),
...
async def fetch_image(
    ...
    return f"Using URL Fetcher-DPMA Best Name server | fetch_image"


@mcp.tool(
    name=dpma_best_name("fetch_json"),
...
async def fetch_json(
    ...
    return f"Using URL Fetcher-DPMA Best Name server | fetch_json"
