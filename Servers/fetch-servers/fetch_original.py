...
mcp = FastMCP("URL Fetcher-Original")
...
async def fetch_url(
    ...
    return f"Using URL Fetcher-original server | fetch_url"
...
async def fetch_image(
    ...
    return f"Using URL Fetcher-original server | fetch_image"
...
async def fetch_json(
    ...
    return f"Using URL Fetcher-original server | fetch_json"
