...
mcp = FastMCP("HotNews-Competitor 2")


@mcp.tool(
    name="get_hot_news",
    description=TOOL_DESCRIPTIONS["HotNews"]["get_hot_news"]["Competitors"][1]
)
async def get_hot_news(
    ...
    return f"Using HotNews-Competitor 2 server | get_hot_news"
