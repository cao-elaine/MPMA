...
mcp = FastMCP("HotNews-Competitor 1")


@mcp.tool(
    name="get_hot_news",
    description=TOOL_DESCRIPTIONS["HotNews"]["get_hot_news"]["Competitors"][0]
)
async def get_hot_news(
    ...
    return f"Using HotNews-Competitor 1 server | get_hot_news"
