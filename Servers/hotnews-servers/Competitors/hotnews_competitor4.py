...
mcp = FastMCP("HotNews-Competitor 4")


@mcp.tool(
    name="get_hot_news",
    description=TOOL_DESCRIPTIONS["HotNews"]["get_hot_news"]["Competitors"][3]
)
async def get_hot_news(
    ...
    return f"Using HotNews-Competitor 4 server | get_hot_news"
