...
mcp = FastMCP("HotNews-Competitor 3")


@mcp.tool(
    name="get_hot_news",
    description=TOOL_DESCRIPTIONS["HotNews"]["get_hot_news"]["Competitors"][2]
)
async def get_hot_news(
    ...
    return f"Using HotNews-Competitor 3 server | get_hot_news"
