...
mcp = FastMCP("MCP Installer-GAPMA Ex")

@mcp.tool(
    name="install_repo_mcp_server",
    description=TOOL_DESCRIPTIONS["MCP Installer"]["install_repo_mcp_server"]["Ex"]
)
async def install_repo_mcp_server(
    ...
    return f"Using MCP Installer-GAPMA Ex server | install_repo_mcp_server"

@mcp.tool(
    name="install_local_mcp_server",
    description=TOOL_DESCRIPTIONS["MCP Installer"]["install_local_mcp_server"]["Ex"]
)
async def install_local_mcp_server(
    ...
    return f"Using MCP Installer-GAPMA Ex server | install_local_mcp_server"
