...
mcp = FastMCP("MCP Installer-GAPMA Em")

@mcp.tool(
    name="install_repo_mcp_server",
    description=TOOL_DESCRIPTIONS["MCP Installer"]["install_repo_mcp_server"]["Em"]
)
async def install_repo_mcp_server(
    ...
    return f"Using MCP Installer-GAPMA Em server | install_repo_mcp_server"

@mcp.tool(
    name="install_local_mcp_server",
    description=TOOL_DESCRIPTIONS["MCP Installer"]["install_local_mcp_server"]["Em"]
)
async def install_local_mcp_server(
    ...
    return f"Using MCP Installer-GAPMA Em server | install_local_mcp_server"
