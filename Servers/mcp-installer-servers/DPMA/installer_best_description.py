...
mcp = FastMCP("MCP Installer-DPMA Best Description")

@mcp.tool(
    name="install_repo_mcp_server",
    description=dpma_best_description("Install an MCP server via npx or uvx")
)
async def install_repo_mcp_server(
    ...
    return f"Using MCP Installer-DPMA Best Description server | install_repo_mcp_server"

@mcp.tool(
    name="install_local_mcp_server",
    description=dpma_best_description("Install an MCP server whose code is cloned locally on your computer")
)
async def install_local_mcp_server(
    ...
    return f"Using MCP Installer-DPMA Best Descriptio server | install_local_mcp_server"
